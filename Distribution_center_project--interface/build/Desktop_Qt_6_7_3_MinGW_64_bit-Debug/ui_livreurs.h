...
"    padding: 8px 16px;\n"
"    font-size: 14px;"));
        QIcon icon4(QIcon::fromTheme(QIcon::ThemeIcon::AudioVolumeLow));
        stateButton->setIcon(icon4);
        tabWidget->addTab(tab_5, QString());
        tab_6 = new QWidget();
        tab_6->setObjectName("tab_6");
        widget_3 = new QWidget(tab_6);
        widget_3->setObjectName("widget_3");
        widget_3->setGeometry(QRect(0, 0, 701, 601));
...
"    font-size: 14px;"));
        QIcon icon5;
        icon5.addFile(QString::fromUtf8(":/new/prefix1/Ressources/update-icon.svg"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        modifier->setIcon(icon5);
...
"    font-size: 14px;"));
        QIcon icon6;
        icon6.addFile(QString::fromUtf8(":/new/prefix1/Ressources/add-circle-outline-svgrepo-com.svg"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        valider->setIcon(icon6);
