...
void Equipments::on_pushButton_10_clicked()
{
...
void Equipments::on_pushButton_clicked()
{
    Dialog *at = new Dialog(this);
    this->close();
}


void Equipments::on_pushButton_3_clicked()
{
    examens *on = new examens(this);
    this->close();
}


void Equipments::on_pushButton_4_clicked()
{
    instituts *mm = new instituts(this);
    this->close();
}
