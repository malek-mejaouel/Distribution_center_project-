...
"    padding: 8px;"));
        ...
        recherche = new QLineEdit(horizontalWidget);
        recherche->setObjectName("recherche");
        recherche->setGeometry(QRect(10, 40, 281, 16));
...
"    font-family: \"Poppins\";"));
        ...
        tab1->setGeometry(QRect(0, 60, 591, 211));
...
"background-color: rgb(179, 179, 179);"));
        ...
        label_11->setGeometry(QRect(350, 30, 71, 21));
        label_11->setStyleSheet(QString::fromUtf8("color: rgb(0, 0, 0);\n"
" font-size: 13px;\n"
"    font-weight: bold;\n"
"    font-family: \"Poppins\";"));
        tri = new QComboBox(horizontalWidget);
        tri->setObjectName("tri");
        tri->setGeometry(QRect(420, 30, 91, 24));
...
"    padding: 8px;"));
        ...
        pushButton_5->setStyleSheet(QString::fromUtf8("background-image: url(:/ressources/up-and-down-arrow.png);"));
        QIcon icon8;
        ...
        b3->setObjectName("b3");
        b3->setGeometry(QRect(410, 250, 80, 31));
        QFont font3;
...
"    padding: 8px;"));
        ...
        b4->setObjectName("b4");
        b4->setGeometry(QRect(510, 250, 80, 31));
        b4->setFont(font3);
...
"    font-size: 14px;\n"
"    padding: 8px;"));
        b10 = new QPushButton(horizontalWidget);
        b10->setObjectName("b10");
        b10->setGeometry(QRect(249, 250, 131, 31));
        b10->setFont(font3);
        b10->setStyleSheet(QString::fromUtf8("  background-color: #FFFFFF;\n"
"  \n"
"    color: #1E2350;\n"
"    border-radius: 10px;\n"
"    font-size: 14px;\n"
"    padding: 8px;"));
        b12 = new QPushButton(horizontalWidget);
        b12->setObjectName("b12");
        b12->setGeometry(QRect(520, 30, 31, 24));
        b12->setStyleSheet(QString::fromUtf8("background-image: url(:/ressources/up-and-down-arrow.png);"));
        QIcon icon9(QIcon::fromTheme(QIcon::ThemeIcon::GoDown));
        b12->setIcon(icon9);
        b13 = new QPushButton(horizontalWidget);
        b13->setObjectName("b13");
        b13->setGeometry(QRect(560, 30, 31, 24));
        b13->setStyleSheet(QString::fromUtf8("background-image: url(:/ressources/up-and-down-arrow.png);"));
        QIcon icon10(QIcon::fromTheme(QIcon::ThemeIcon::GoUp));
        b13->setIcon(icon10);
...
"    font-weight: bold;\n"
"    font-family: \"Poppins\";"));
        quantite_input = new QLineEdit(horizontalGroupBox);
        quantite_input->setObjectName("quantite_input");
        quantite_input->setGeometry(QRect(160, 70, 141, 16));
        quantite_input->setStyleSheet(QString::fromUtf8("background-color: rgb(255, 255, 255);\n"
"color: rgb(0, 0, 0);"));
        marque_input = new QLineEdit(horizontalGroupBox);
        marque_input->setObjectName("marque_input");
        marque_input->setGeometry(QRect(160, 140, 141, 16));
        marque_input->setStyleSheet(QString::fromUtf8("background-color: rgb(255, 255, 255);\n"
"color: rgb(0, 0, 0);"));
        type_input = new QLineEdit(horizontalGroupBox);
        type_input->setObjectName("type_input");
        type_input->setGeometry(QRect(150, 170, 141, 16));
        type_input->setStyleSheet(QString::fromUtf8("background-color: rgb(255, 255, 255);\n"
"color: rgb(0, 0, 0);"));
        b1 = new QPushButton(horizontalGroupBox);
        b1->setObjectName("b1");
        b1->setGeometry(QRect(380, 130, 80, 31));
        b1->setFont(font3);
...
"    font-size: 14px;\n"
"    padding: 8px;"));
        b2 = new QPushButton(horizontalGroupBox);
        b2->setObjectName("b2");
        b2->setGeometry(QRect(510, 130, 80, 31));
        b2->setFont(font2);
...
"    font-weight: bold;\n"
"    font-family: \"Poppins\";"));
        prix_input = new QLineEdit(horizontalGroupBox);
        prix_input->setObjectName("prix_input");
        prix_input->setGeometry(QRect(150, 200, 141, 16));
        prix_input->setStyleSheet(QString::fromUtf8("background-color: rgb(255, 255, 255);\n"
"color: rgb(0, 0, 0);"));
...
"color: rgb(0, 0, 0);"));
        b7 = new QPushButton(horizontalGroupBox);
        b7->setObjectName("b7");
        b7->setGeometry(QRect(500, 40, 80, 31));
        b7->setFont(font3);
        b7->setStyleSheet(QString::fromUtf8("  background-color: #FFFFFF;\n"
"  \n"
"    color: #1E2350;\n"
"    border-radius: 10px;\n"
"    font-size: 14px;\n"
"    padding: 8px;"));
        ...
        chartViewFunctionalites = new QChartView(tab_6);
        chartViewFunctionalites->setObjectName("chartViewFunctionalites");
        chartViewFunctionalites->setGeometry(QRect(0, 0, 301, 241));
        calendarWidget = new QCalendarWidget(tab_6);
        calendarWidget->setObjectName("calendarWidget");
        calendarWidget->setGeometry(QRect(305, 2, 291, 241));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        pushButton_13->setText(QCoreApplication::translate("MainWindow", "param\303\250tre ", nullptr));
        ...
        b10->setText(QCoreApplication::translate("MainWindow", "Export pdf", nullptr));
#if QT_CONFIG(tooltip)
        b12->setToolTip(QCoreApplication::translate("MainWindow", "<html><head/><body><p><img src=\":/ressources/up-and-down-arrow.png\"/></p></body></html>", nullptr));
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(whatsthis)
        b12->setWhatsThis(QCoreApplication::translate("MainWindow", "<html><head/><body><p><img src=\":/ressources/up-and-down-arrow.png\"/></p></body></html>", nullptr));
#endif // QT_CONFIG(whatsthis)
        b12->setText(QString());
#if QT_CONFIG(tooltip)
        b13->setToolTip(QCoreApplication::translate("MainWindow", "<html><head/><body><p><img src=\":/ressources/up-and-down-arrow.png\"/></p></body></html>", nullptr));
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(whatsthis)
        b13->setWhatsThis(QCoreApplication::translate("MainWindow", "<html><head/><body><p><img src=\":/ressources/up-and-down-arrow.png\"/></p></body></html>", nullptr));
#endif // QT_CONFIG(whatsthis)
        b13->setText(QString());
        label_3->setText(QCoreApplication::translate("MainWindow", "Nom :", nullptr));
        nom_input->setText(QString());
        ...
        b7->setText(QCoreApplication::translate("MainWindow", "Afficher", nullptr));
