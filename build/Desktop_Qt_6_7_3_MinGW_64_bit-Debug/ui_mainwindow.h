...
"    padding: 8px;"));
        ...
        pushButton_10->setStyleSheet(QString::fromUtf8("  background-color: rgb(175,175,175);\n"
"    color: #1E2350;\n"
"    border-radius: 10px;\n"
"    font-size: 14px;\n"
"    padding: 8px;"));
...
"    padding: 8px;"));
        ...
        searchLineEdit = new QLineEdit(horizontalWidget);
        searchLineEdit->setObjectName("searchLineEdit");
        searchLineEdit->setGeometry(QRect(10, 40, 281, 16));
        searchLineEdit->setStyleSheet(QString::fromUtf8("color:black;"));
...
"    font-weight: bold;\n"
"    font-family: \"Poppins\";"));
        sortComboBox = new QComboBox(horizontalWidget);
        sortComboBox->addItem(QString());
        sortComboBox->addItem(QString());
        sortComboBox->setObjectName("sortComboBox");
        sortComboBox->setGeometry(QRect(470, 30, 91, 24));
        sortComboBox->setStyleSheet(QString::fromUtf8("background-color : blue;color:white;"));
...
"    padding: 8px;"));
        ...
        supprimer = new QPushButton(horizontalWidget);
        supprimer->setObjectName("supprimer");
        supprimer->setGeometry(QRect(410, 240, 80, 24));
        supprimer->setStyleSheet(QString::fromUtf8("color:blue;"));
        modifier = new QPushButton(horizontalWidget);
        modifier->setObjectName("modifier");
        modifier->setGeometry(QRect(510, 240, 80, 24));
        modifier->setStyleSheet(QString::fromUtf8("color:blue;"));
        tab = new QTabWidget(centralwidget);
        tab->setObjectName("tab");
        tab->setGeometry(QRect(200, 0, 601, 291));
        tab->setStyleSheet(QString::fromUtf8("/* Style the entire TabWidget */\n"
"QTabWidget::pane {\n"
...
""));
        ...
        horizontalGroupBox->setGeometry(QRect(-20, -30, 621, 281));
...
"    font-family: \"Poppins\";"));
        ...
        label_7->setGeometry(QRect(40, 120, 81, 20));
...
"    font-family: \"Poppins\";"));
        ...
        label_9->setGeometry(QRect(40, 160, 81, 20));
...
"    font-family: \"Poppins\";"));
        ...
        label_10->setGeometry(QRect(40, 200, 81, 20));
        label_10->setStyleSheet(QString::fromUtf8("color: rgb(0, 0, 0);\n"
" font-size: 13px;\n"
"    font-weight: bold;\n"
"    font-family: \"Poppins\";"));
        valider = new QPushButton(horizontalGroupBox);
        valider->setObjectName("valider");
        valider->setGeometry(QRect(400, 180, 80, 24));
        valider->setStyleSheet(QString::fromUtf8("color:blue;background-color:white;"));
        annuler = new QPushButton(horizontalGroupBox);
        annuler->setObjectName("annuler");
        annuler->setGeometry(QRect(510, 180, 80, 24));
        annuler->setStyleSheet(QString::fromUtf8("color:blue;background-color:white;"));
        examenComboBox = new QComboBox(horizontalGroupBox);
        examenComboBox->setObjectName("examenComboBox");
        examenComboBox->setGeometry(QRect(220, 40, 121, 24));
        examenComboBox->setStyleSheet(QString::fromUtf8("color:blue;background-color:white;"));
        etatComboBox = new QComboBox(horizontalGroupBox);
        etatComboBox->setObjectName("etatComboBox");
        etatComboBox->setGeometry(QRect(220, 120, 121, 24));
        etatComboBox->setStyleSheet(QString::fromUtf8("color:blue;background-color:white;"));
        statusComboBox = new QComboBox(horizontalGroupBox);
        statusComboBox->setObjectName("statusComboBox");
        statusComboBox->setGeometry(QRect(220, 80, 121, 24));
        statusComboBox->setStyleSheet(QString::fromUtf8("color:blue;background-color:white;"));
        destinationComboBox = new QComboBox(horizontalGroupBox);
        destinationComboBox->setObjectName("destinationComboBox");
        destinationComboBox->setGeometry(QRect(220, 160, 121, 24));
        destinationComboBox->setStyleSheet(QString::fromUtf8("color:blue;background-color:white;"));
        livreurComboBox = new QComboBox(horizontalGroupBox);
        livreurComboBox->setObjectName("livreurComboBox");
        livreurComboBox->setGeometry(QRect(220, 200, 121, 24));
        livreurComboBox->setStyleSheet(QString::fromUtf8("color:blue;background-color:white;"));
        tab->addTab(widget, QString());
        tab_6 = new QWidget();
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        label_8->setText(QCoreApplication::translate("MainWindow", "Recherche de Box par ID : ", nullptr));
        QTableWidgetItem *___qtablewidgetitem = tableWidget->horizontalHeaderItem(0);
        ___qtablewidgetitem->setText(QCoreApplication::translate("MainWindow", "ID_Box", nullptr));
        QTableWidgetItem *___qtablewidgetitem1 = tableWidget->horizontalHeaderItem(1);
        ___qtablewidgetitem1->setText(QCoreApplication::translate("MainWindow", "Examen", nullptr));
        QTableWidgetItem *___qtablewidgetitem2 = tableWidget->horizontalHeaderItem(2);
        ___qtablewidgetitem2->setText(QCoreApplication::translate("MainWindow", "Date_Cr\303\251ation", nullptr));
        QTableWidgetItem *___qtablewidgetitem3 = tableWidget->horizontalHeaderItem(3);
        ___qtablewidgetitem3->setText(QCoreApplication::translate("MainWindow", "Livreur", nullptr));
        QTableWidgetItem *___qtablewidgetitem4 = tableWidget->horizontalHeaderItem(4);
        ___qtablewidgetitem4->setText(QCoreApplication::translate("MainWindow", "Destination", nullptr));
        ...
        sortComboBox->setItemText(0, QCoreApplication::translate("MainWindow", "Status", nullptr));
        sortComboBox->setItemText(1, QCoreApplication::translate("MainWindow", "Etat", nullptr));
        ...
        label_4->setText(QCoreApplication::translate("MainWindow", "Examen:", nullptr));
        ...
        label_10->setText(QCoreApplication::translate("MainWindow", "Livreur :", nullptr));
        ...
        tab->setTabText(tab->indexOf(widget), QCoreApplication::translate("MainWindow", "Ajouter Box", nullptr));
        tab->setTabText(tab->indexOf(tab_6), QCoreApplication::translate("MainWindow", "Fonctionalit\303\251s", nullptr));
    } // retranslateUi
