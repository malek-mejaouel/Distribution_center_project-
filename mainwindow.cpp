...
void MainWindow::on_tableView_clicked(const QModelIndex &index)
{
    ...
    if (reply == QMessageBox::Yes) {
        ...
        QString apiKey = "000724293cmsh410f951e7c96171p13b8efjsn9b956b3849f4";
...
void MainWindow::on_lineEdit_8_textChanged(const QString &valeur)
{
...
void MainWindow::on_comboBoxTri_2_currentTextChanged(const QString &choix)
{
    QString critere = ui->comboBoxTri->currentText();
...
/*
int MainWindow::sendEmail(QString dist, QString obj, QString bdy)
{
...
*/
void MainWindow::on_generer_correction_clicked()
{

    QString userMessage="Proposer un correction de cette examen:"+extractText+"en limitant le message de la correction par le mot Début: et pour finir le mot Fin:";
            ...
            if (responseObject.contains("text")) {
                ...
                if (start != -1 && end != -1 && end > start) {
                    ...
                    if (!filePath.isEmpty()) {
                        ...
                        painter.end();
                        int result = sendEmail("sassistate@gmail.com", "Correction examen", "fichier pdf", filePath);
...
int MainWindow::sendEmail(QString recipient, QString subject, QString body, QString pdfPath)
{
    QString smtpServer = "smtp.gmail.com";
    int smtpPort = 465;
    QString username = "rayensassi1235@gmail.com";
    QString password = "camx avha gsaz dzvx";//changer selon le pc !!!  t7el el email fel pc o t3awed ta5o ell mote de pass d'apllication , gerer compte -> securite -> validation 2 facteur -> mote de passe d'aplcation -> create new -> copier le code !!!
